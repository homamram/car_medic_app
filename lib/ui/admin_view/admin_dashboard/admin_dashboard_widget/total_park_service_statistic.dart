...
class TotalParkStatisticDashBoard extends StatelessWidget {
  TotalParkStatisticDashBoard({super.key});
              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: CustomDropMenu(
                      ...
                      onChanged: (value) {
                        ...
                        if (adminDashboardController.parkNameTotalPark ==
                            'All') {
                          adminDashboardController.getCountALlParks();
                        } else {
                          adminDashboardController.getNumberOfLocationByPark(
                              parkingname:
                ...
                adminDashboardController.parkCount.isEmpty
                    ...
                    : Padding(
                        ...
                        child: BarChart(
                          BarChartData(
                              maxY: adminDashboardController.parkCount[0].total!
                                      .toDouble() +
                                  5,
                              ...
                              barGroups: List.generate(
                                  adminDashboardController.parkCount.length,
                                  (index) {
